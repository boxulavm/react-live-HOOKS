...
const Progres = (props) => {
    ...
    return (
        <>
            <div className="col-md-12 bg-secondary mb-5">
                <table className="table">
                    ...
                    <tbody className="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="progress">
                                    <div className="progress-bar bg-danger" role="progressbar" style={{ width: `${num1}%` }} aria-valuenow={num1} aria-valuemin="0" aria-valuemax="100">{num1}%</div>
                                </div>
                            </td>
                            <td>{num1}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="progress">
                                    <div className="progress-bar bg-warning" role="progressbar" style={{ width: `${num3 + 1}%` }} aria-valuenow={num3 + 1} aria-valuemin="0" aria-valuemax="100">{num3 + 1}%</div>
                                </div>
                            </td>
                            <td>{num3 + 1}</td>
                        </tr>
